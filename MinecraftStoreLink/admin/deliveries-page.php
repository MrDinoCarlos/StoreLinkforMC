...
add_action('admin_menu', 'minecraftstorelink_add_deliveries_submenu');

function minecraftstorelink_add_deliveries_submenu() {
    add_submenu_page(
        'minecraftstorelink',
        'Pending Deliveries',
        'Deliveries',
        'manage_woocommerce',
        'minecraftstorelink_deliveries',
        'minecraftstorelink_render_deliveries_page'
    );
}

function minecraftstorelink_render_deliveries_page() {
    global $wpdb;
